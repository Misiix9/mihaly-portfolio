        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.isArray(categories) && categories.map((cat, idx) => (
            <div
              key={idx}
              ref={reveal}
              className="group rounded-xl border border-white/10 bg-white/5 p-6 transition-transform duration-300 will-change-transform hover:-translate-y-1 hover:bg-white/7.5"
            >
